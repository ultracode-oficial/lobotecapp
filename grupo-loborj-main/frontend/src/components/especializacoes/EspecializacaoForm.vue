...
<template>
  <form @submit.prevent="handleSubmit" class="space-y-8">
    <div class="space-y-5">
      <!-- Informações da Especialização -->
      <div>
        <div>
          <h3 class="text-lg font-medium leading-6 text-gray-900">Dados da Especialização/Requisito</h3>
          <p class="mb-5 text-sm text-gray-500">Defina o nome e propósito desta especialização/requisito.</p>
        </div>
        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
          <div class="sm:col-span-4">
            <label class="block text-sm font-medium text-slate-700 mb-1">Nome da Especialização/Requisito <span
          ...
          <div class="sm:col-span-6">
            ...
            <textarea v-model="form.description" rows="3"
              placeholder="Ex.: Capacitação para trabalhar com instalações e serviços em eletricidade, conforme a Norma Regulamentadora 10."
